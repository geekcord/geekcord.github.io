<div class="bg-[#2b2d31] h-full w-full md:w-60 hide-in-menu">
    ...
    <footer class="w-full p-2 md:w-60 bottom-0 absolute h-auto  bg-[#232428]">
        <div class="flex flex-row justify-between">
            
            <div class="flex flex-row hover:bg-[#383940] p-1 rounded-md flex-1">
                <div>
            ...
            <div class="text-gray-400 items-center content-center flex space-x-1 mr-1">
